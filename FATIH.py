...
# -*- coding: utf-8 -*-
        ...
        #############################################
        #                                           #
        #    Facebook BruteForce, by BlackEagle     #
        #    Facebook Contact:       FaTiH          #
        #                                           #
        #############################################
...
print '\n\nCracking '+user+' Now...'
time.sleep(1)
print '\nIM NOT RESPONSIBLE FOR ANY MISS USE MUSAWER FATIH\n'
print '\nThis Tool Can H4CK Any Account No-Matter How The Strong Password Will Be\n'
print '\nThis TOOl Is Developed By Musawer-Fatih (TheBlackEagle)\n'
